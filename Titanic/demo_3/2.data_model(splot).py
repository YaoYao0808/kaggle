...
#将上述X数据分为两部分，取出验证集数据
X_1, X_2, y_1, y_2 = train_test_split(X, y, test_size=0.33)
print("X_2.len:",len(X_2))  #295


# 1.KNN:using the Specify the parameters
knn = KNeighborsClassifier(algorithm='auto', leaf_size=26, metric='minkowski',
                           metric_params=None, n_jobs=1, n_neighbors=6, p=2,
                           weights='uniform')
knn_clf=knn.fit(X, y)
y_pred_2 = knn.predict(X_2)
...
print("accuracy_score_knn:",accuracy_score(y_2, y_pred))
# calulate auc and roc curve
from sklearn.metrics import roc_curve, auc
y_score=knn_clf.predict_proba(X_2[:,1])
# print(y_2.shape)  (295,)
# print(y_score.shape)(295, 2)
fpr, tpr, threshold = roc_curve(y_2, y_score)
roc_auc = auc(fpr, tpr)
# matplotlib curve roc
plt.figure()
lw = 2
...
# y_pred=reg_lr.predict(X_2)
# print("accuracy_score_LogisticRegression:",accuracy_score(y_2, y_pred))
