...
# onil using these features
features = ['Pclass','Sex','Age','Fare']

#Processing data
# isnull sum:Age(177),Cabin(687),Embarked(2)
le = LabelEncoder()
...
# if nan,fillna is true
# when using the method LabelEncoder(),the fearures should be transformed to be None
